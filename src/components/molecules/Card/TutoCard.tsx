...
const TutoCard: React.FC<TutoCardProps> = ({ id, title, estimated_time }) => {
  ...
  return (
      <div
        className="bg-minecraft-card border-2 w-1/4 h-1/6 border-black relative cursor-pointer flex flex-col items-center justify-between rounded-lg shadow-lg transition-transform transform hover:scale-105"
        onClick={handleClick}
      >
