...
const HomePage: React.FC = () => {
  ...
  return (
    <div className='flex flex-col justify-center gap-10 lg:mx-10'>
      ...
      <Card title="Pourquoi choisir EasyMod ?" useAwesometitle={true} bg="bg-deepslate" className='w-full lg:w-10/12 my-10'>
        <div className='w-full lg:w-1/2 lg:m-auto self-center my-10'>
            <ul>
              <li className='my-10 text-xl minecraftText'><MinecraftText size='text-3xl'>Guide Complet et Accessible :</MinecraftText> Nos tutoriels sont elabores pour tous les âges et tous les niveaux. 
              ...
              <li className='my-10 text-xl minecraftText'><MinecraftText size='text-3xl'>De l&apos;Installation à l&apos;Action :</MinecraftText> Nous vous guidons à travers tout le processus, depuis l&apos;installation 
              ...
              <li className='my-10 text-xl minecraftText'><MinecraftText size='text-3xl'>Communaute et Support :</MinecraftText> Chez EasyMod, nous croyons en la puissance de la communaute. 
              ...
              <li className='my-10 text-xl minecraftText'><MinecraftText size='text-3xl'>Inspirations et Creativite :</MinecraftText> Explorez nos tutoriels et projets inspirants pour stimuler
              ...
              <li className='my-10 text-xl minecraftText'><MinecraftText size='text-3xl'>Mises à Jour et Nouveautes :</MinecraftText> Restez à la pointe des dernières tendances et mises à jour 
